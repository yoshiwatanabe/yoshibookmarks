...
│       │   ├── ai_inference.py      # AI/embedding inference helpers
│       │   ├── ingestion_service.py # Browser-extension capture workflows
│       │   ├── recall_service.py    # Natural-language recall (hybrid search)
...
- `test_ai_inference.py`: AI/embedding inference helpers
- `test_api_recall.py`: Keyword and semantic recall
