...
**IngestionService**
- Content ingestion pipeline (preview/commit/quick-save)
...
> **Note**: Screenshot capture (Playwright) is available as a planned feature.
...
│       │   └── ai_inference.py      # AI/LLM helper utilities
│       │
