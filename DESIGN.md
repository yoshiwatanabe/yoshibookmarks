...
│       │   ├── ai_inference.py      # AI/embedding inference
│       │   ├── ingestion_service.py # Browser extension capture logic
