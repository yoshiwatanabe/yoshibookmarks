...
- Result ranking and filtering (hybrid keyword + semantic scoring)
...
- Multi-provider AI inference for keyword/title generation
- Provider failover chain (OpenAI, Azure OpenAI, Anthropic, Gemini)
