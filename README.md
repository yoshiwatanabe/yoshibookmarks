...
- `POST /bookmarks/{id}/access` - Record last-accessed timestamp for a bookmark

See the auto-generated API docs at `http://127.0.0.1:<port>/docs` for complete API documentation.
