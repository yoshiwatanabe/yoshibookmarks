...
- `DELETE /bookmarks/{id}` - Delete bookmark (soft by default; add `?hard=true` for permanent)
...
- `GET /ingest/preview/{preview_id}/diagnostics` - Per-preview provider trace diagnostics
