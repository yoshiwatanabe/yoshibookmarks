...
- `POST /bookmarks/{id}/access` - Record bookmark access (updates last-accessed timestamp)
...
- `GET /ingest/preview/{preview_id}/diagnostics` - Diagnostics for a specific preview capture
