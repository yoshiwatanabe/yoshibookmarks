...
- `POST /bookmarks/{id}/access` - Record a bookmark access (updates last accessed timestamp)
...
- `GET /ingest/preview/{preview_id}/diagnostics` - Get provider trace for a preview
...
- **Documentation**: See `DESIGN.md` and `spec.md`
