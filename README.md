...
- `DELETE /bookmarks/{id}` - Delete bookmark (soft delete by default; use `?hard=true` for permanent)
...
- `GET /ingest/preview/{preview_id}/diagnostics` - Get provider trace for a specific preview
